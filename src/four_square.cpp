...
struct split : fitness_function<unary_fitness<double>, constantS, stochasticS> {
    ...
    double operator()(Individual& ind, RNG& rng, EA& ea) {
        ...
        double fx = f4_00 * f1_10 * f2_01 * f3_11;
        fs(fx);
        
        fx = f4_00 * f1_10 * f2_11 * f3_01;
        fs(fx);
        
        fx = f4_00 * f1_01 * f2_10 * f3_11;
        fs(fx);
        
        fx = f4_00 * f1_01 * f2_11 * f3_10;
        fs(fx);
        
        fx = f4_00 * f1_11 * f2_10 * f3_01;
        fs(fx);
        
        fx = f4_00 * f1_11 * f2_01 * f3_10;
        fs(fx);
        
        
        
        
        fx = f4_10 * f1_00 * f2_01 * f3_11;
        fs(fx);
        
        fx = f4_10 * f1_00 * f2_11 * f3_01;
        fs(fx);
        
        fx = f4_10 * f1_01 * f2_00 * f3_11;
        fs(fx);
        
        fx = f4_10 * f1_01 * f2_11 * f3_00;
        fs(fx);
        
        fx = f4_10 * f1_11 * f2_00 * f3_01;
        fs(fx);
        
        fx = f4_10 * f1_11 * f2_01 * f3_00;
        fs(fx);
        
        
        
        
        fx = f4_11 * f1_00 * f2_01 * f3_10;
        fs(fx);
        
        fx = f4_11 * f1_00 * f2_10 * f3_01;
        fs(fx);
        
        fx = f4_11 * f1_01 * f2_00 * f3_10;
        fs(fx);
        
        fx = f4_11 * f1_01 * f2_10 * f3_00;
        fs(fx);
        
        fx = f4_11 * f1_10 * f2_00 * f3_01;
        fs(fx);
        
        fx = f4_11 * f1_10 * f2_01 * f3_00;
        fs(fx);
        
        
        
        
        fx = f4_01 * f1_00 * f2_11 * f3_10;
        fs(fx);
        
        fx = f4_01 * f1_00 * f2_10 * f3_11;
        fs(fx);
        
        fx = f4_01 * f1_11 * f2_00 * f3_10;
        fs(fx);
        
        fx = f4_01 * f1_11 * f2_10 * f3_00;
        fs(fx);
        
        fx = f4_01 * f1_10 * f2_00 * f3_11;
        fs(fx);
        
        fx = f4_01 * f1_10 * f2_11 * f3_00;
        fs(fx);
