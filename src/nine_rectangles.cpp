 ...
 */
struct nine_rectangles : fitness_function<unary_fitness<double>, constantS, stochasticS> {
    ...
    double operator()(Individual& ind, RNG& rng, EA& ea) {
        ...
        for (int xy = 0; xy<grid_size; xy++) {
            ...
            if ( (agent_y >= ((floor(max_x) / 3))) && (agent_y < ((floor(max_x) / 3 * 2)))) {
                ...
                if ((agent_x < (floor(max_x) / 3 )) ||  (agent_x >= ((floor(max_x) / 3 * 2)))){
                    if (((as[p]).output(0) == 1) &&  ((as[p]).output(1) == 0)){
                        ++f4_10;
                    } else if (((as[p]).output(0) == 0) &&  ((as[p]).output(1) == 1)){
                        ++f4_01;
                ...
                } else { // (agent_x >= (floor(max_x) / 3)) && (agent_x < ((floor(max_x) / 3 * 2))))
                    if (((as[p]).output(0) == 1) &&  ((as[p]).output(1) == 0)){
                        ++f5_10;
                    } else if (((as[p]).output(0) == 0) &&  ((as[p]).output(1) == 1)){
                        ++f5_01;
        ...
        double fx = f1_10 * f2_01 * f3_11 * f4_01 * f5_00;
        fs(fx);
        fx = f1_10 * f2_01 * f3_11 * f4_01 * f5_10;
        fs(fx);
        fx = f1_10 * f2_01 * f3_11 * f4_01 * f5_11;
        fs(fx);
        
        
        fx = f1_10 * f2_11 * f3_01 * f4_11 * f5_00;
        fs(fx);
        fx = f1_10 * f2_11 * f3_01 * f4_11 * f5_01;
        fs(fx);
        fx = f1_10 * f2_11 * f3_01 * f4_11 * f5_10;
        fs(fx);
        
        fx = f1_01 * f2_10 * f3_11 * f4_10 * f5_00;
        fs(fx);
        fx = f1_01 * f2_10 * f3_11 * f4_10 * f5_01;
        fs(fx);
        fx = f1_01 * f2_10 * f3_11 * f4_10 * f5_11;
        fs(fx);
        
        fx = f1_01 * f2_11 * f3_10 * f4_11 * f5_00;
        fs(fx);
        fx = f1_01 * f2_11 * f3_10 * f4_11 * f5_01;
        fs(fx);
        fx = f1_01 * f2_11 * f3_10 * f4_11 * f5_10;
        fs(fx);
        
        fx = f1_11 * f2_01 * f3_10 * f4_01 * f5_00;
        fs(fx);
        fx = f1_11 * f2_01 * f3_10 * f4_01 * f5_10;
        fs(fx);
        fx = f1_11 * f2_01 * f3_10 * f4_01 * f5_11;
        fs(fx);
        
        fx = f1_11 * f2_10 * f3_01 * f4_10 * f5_00;
        fs(fx);
        fx = f1_11 * f2_10 * f3_01 * f4_10 * f5_01;
        fs(fx);
        fx = f1_11 * f2_10 * f3_01 * f4_10 * f5_11;
        fs(fx);
