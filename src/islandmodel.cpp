...
struct island : fitness_function<unary_fitness<double>, constantS, stochasticS> {
    ...
    double operator()(Individual& ind, RNG& rng, EA& ea) {
        ...
        switch(is) {
            case 0:
                f = outline(grid_size, max_x, max_y, agent_pos, as, ea);
                break;
            case 1:
                f = outline_split(grid_size, max_x, max_y, agent_pos, as, ea);
                break;
            case 2:
                f = outline_split2(grid_size, max_x, max_y, agent_pos, as, ea);
                break;
            case 3:
                f = outline_quad(grid_size, max_x, max_y, agent_pos, as, ea);
                break;
            default:
                f = 1;
        }
